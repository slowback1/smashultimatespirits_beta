<?php
    //POST request with 2 parameters, id, which is an integer for the question id, and answer, which is an integer of the answer id.  id should be passed through from your initial getOne request.
